...
//class for LinkedLists of transactions
    public class LinkedList
    {
      ...
      //it indicates the size of the list
       ...
       public LinkedList() //LinkedList Constructor - function name the same as class name
      {
   ...
   ///////// THE FOLLOWING CODE TRAVERSES THE LIST ////////////
       ...
       public void add(transaction data, int index)
       //adds a node in a certain position of the linkedlist
      {
       ...
       public transaction get(int index)//function with return type 'Object'
      {
         if(index <= 0)
       ...
       public class Node
      {
         ...
         //data is the object of the data stored
          ...
          public Node(transaction _data) //a constructor [function has same name as the class]
         ...
         //the constructor takes the parameter of Object _data
         {
          ...
          public Node(transaction _data, Node _next) //constructor that takes 2 parameters from the user
          ...
          //_next holds the pointer to the next node
         {
          ...
          public transaction getData() //query - returns data
          //function getData()
         {
            return data; //returns the data stored in the node as type Object
         }
      
          public void setData(transaction _data) //function setData() that takes in parameter of _data
